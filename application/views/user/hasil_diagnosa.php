    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <?php if(sizeof($listPenyakit)>0) { ?>
                <p>
                    Berdasarkan gejalanya, Pasien di prediksi mengidap penyakit <b><?php echo $dataHasil['nama'];?></b> dengan tingkat kepercayaan <b><?php echo $dataHasil['kepercayaan'];?> %</b><br/>
