			...
			<div class="wrap-login100">
				<section class="login100-form validate-form">
					<span class="login100-form-title p-b-34" style="font-family: arial">
						LOGIN  SISTEM PAKAR PENYAKIT TELINGA HIDUNG TENGGOROKAN (THT)
						<span style="text-align: center !important; font-size: 12px; text-transform: none;"> </span>
					</span>
					...
					<div class="w-full text-center p-t-27 p-b-239" >
						...
						<a href="#" target="_blank" class="txt2" style="color: #3EA8FF" style="font-family: arial">
							Sistem Pakar
						</a>
					</div>
				...
				<div class="login100-more" style="background-image: url('<?php echo base_url() ?>assets/templatelogin/images/cd.jpg');"></div>
			</div>
		</div>
	</div>
